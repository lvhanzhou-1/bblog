...
<!--        <IconFont :icon-class="{width:'20px',height:'20px'}" :icon-href="'icon-pinglun'"></IconFont>-->
        ...
        <main>
            <!--   轮播图：一级推荐   -->
            <FirstRecommend :list="level1List" @toArticleDetailHandle="toArticleDetailHandle"></FirstRecommend>
            <!--   文章列表   -->
            <Articles
...
export default {
    ...
    methods: {
        //跳转文章详情，  在单击事件或者在函数中实现页面跳转，新窗口打开
