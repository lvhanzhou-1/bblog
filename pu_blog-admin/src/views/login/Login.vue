<template>
    <div class="login-container">
        <el-form class="login-form" :model="loginForm">
            ...
            <div class="test-user-info"><span>测试用户：testUser</span><span>密码：testUser</span></div>
            <el-form-item>
                <el-button
                    type="primary"
                    style="width: 100%"
...
// import {testUserInfo} from "@/lib/config"
...
export default {
    ...
    methods: {
        async handleLogin() {
            ...
            if (data.code === 1) {
                // 登录成功后，把token存到vuex中,并存到cookie中
                this.$store.commit(userMutation.SET_TOKEN, data.data);

                // // //登录成功后，判断是否是演示账号
                // if (this.loginForm.username === testUserInfo.testUserName) {
                // 	setIsDemoVersionInLocalStorage(true)
                // }
                /*保存完token，就跳转到首页*/
...
/*=================================================*/
/*一定要加上rel="stylesheet/scss"， 否则不起作用，为什么？*/
