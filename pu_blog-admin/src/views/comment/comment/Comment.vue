    ...
    <div class="comment-container">
        ...
        <div class="table-container" :style="{height: `calc(100% - ${calcTableHeight}px)`}">
            ...
            >
                ...
                <el-table-column label="评论内容" min-width="100" align="center">
                    <template slot-scope="scope">
                        <span>{{ new_comment_content(scope.row.comment_content) }}</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="'批量'+ deleteDialogTitle "
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <!-- <el-button type="danger" @click="deleteConfirmHandle">确定{{ deleteDialogTitle }}</el-button> -->
            </div>
        </el-dialog>
    ...
    methods: {
        ...
        handleEdit(row) {
            ...
            */
            this.form = {
                uid: row.uid,
                commentContent: this.new_comment_content(row.comment_content),
