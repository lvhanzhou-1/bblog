<template>
    ...
    <div class="admin-user-container">
        ...
        <div class="feature-btns" :style="{height: `${featureBtnsHeight}px`}">
            <el-row :gutter="10">
                <el-col :span="1.5">
                    <el-button class="filter-item" type="primary" @click="handleAdd" :disabled="isDemoVersion" icon="el-icon-edit"
                    >添加
                    </el-button>
                </el-col>
        ...
        <div class="table-container" :style="{height: `calc(100% - ${calcTableHeight}px)`}">
            ...
            >
                ...
                <el-table-column label="操作" fixed="right" min-width="250" align="center">
                    <template slot-scope="scope">
                       <el-button @click="handleReset(scope.row)" type="warning" size="small" :disabled="isDemoVersion">密码重置</el-button>
                        <el-button @click="handleEdit(scope.row)" type="primary" size="small" :disabled="isDemoVersion">编辑
                        </el-button>
