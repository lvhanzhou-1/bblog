import { appMutation } from "../mutation-types";
...
import {
	...
	// getIsDemoVersionInLocalStorage
} from "@/lib/local";
...
export default {
	state: {
		...
		tagNavList: [],
		//
		// //控制是否是演示账号，如果是，则禁用增 删 改 按钮
		// isDemoVersion: getIsDemoVersionInLocalStorage() || false,
	},
	getters: {},
	mutations: {
		/*=========================================================================*/
/**
		 * @description 是否是演示版本
		 */
		// [appMutation.CHANGE_DEMOVERSION](state) {
		// 	state.isDemoVersion = true;
		// },
